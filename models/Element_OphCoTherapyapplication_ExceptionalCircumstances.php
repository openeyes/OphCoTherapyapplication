 ...
 * @property integer $inteventions_id
...
class Element_OphCoTherapyapplication_ExceptionalCircumstances extends BaseEventTypeElement
{
	...
	public function rules()
	{
		...
		return array(
			array('event_id, standard_intervention_exists, details, inteventions_id, description, patient_factors, patient_factor_details, ', 'safe'),
			array('standard_intervention_exists, details, inteventions_id, description, patient_factors, patient_factor_details, ', 'required'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, event_id, standard_intervention_exists, details, inteventions_id, description, patient_factors, patient_factor_details, ', 'safe', 'on' => 'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'inteventions' => array(self::BELONGS_TO, 'Element_OphCoTherapyapplication_ExceptionalCircumstances_Inteventions', 'inteventions_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('inteventions_id', $this->inteventions_id);
