...
<div id="OphCoTherapyapplication_ComplianceCalculator_<?php echo $side ?>"<?php if ($decisiontree) {
    ...
    ?>
			<div class="dt-node field-row" id="<?php echo $side;
    ?>_node_<?php echo $node->id ?>" style="display: none;" data-defn='<?php echo CJSON::encode($node->getDefinition());
    ?>'>
				<?php if ($node->question) {
    ?>
					<label for="Element_OphCoTherapyapplication_PatientSuitability_<?php echo $side;
    ?>_DecisionTreeResponse_<?php echo $node->id;
    ?>">
    ...
    if ($node->response_type->datatype == 'bool') {
        ?>
						<select
							id="Element_OphCoTherapyapplication_PatientSuitability_<?php echo $side;
        ?>_DecisionTreeResponse_<?php echo $node->id;
        ?>"
							name="Element_OphCoTherapyapplication_PatientSuitability[<?php echo $side;
        ?>_DecisionTreeResponse][<?php echo $node->id;
        ?>]">
    ...
    ?>_outcome_<?php echo $outcome->id ?>" style="display: none;" class="outcome <?php echo $outcome->isCompliant() ? "compliant" : "non-compliant";
    ?>"
