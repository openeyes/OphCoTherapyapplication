...
*/
$form->multiSelectList($element, $side . '_filecollections', $side . '_filecollections', 'id', CHtml::listData($collections,'id','name'), array(), $html_options, false, false, null, false, false, array('label' => 4,'field' => 6));
?>
